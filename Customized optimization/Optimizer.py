...
import optimizers.CMF as cmf
import optimizers.MFOS as mfos
import optimizers.MFO as mfo
import optimizers.MFOL as mfol
import benchmarks
import csv
import numpy
import time
...
def selector(algo, func_details, popSize, Iter):
    ...
    if algo == "CMF":
        x = mvo.CMF(getattr(benchmarks, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "MFOS":
        x = gwo.MFOS(getattr(benchmarks, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "MFO":
        x = mfo.MFO(getattr(benchmarks, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "MFOL":
        x = mfos.MFOL(getattr(benchmarks, function_name), lb, ub, dim, popSize, Iter)
    else:
        return null
    return x
